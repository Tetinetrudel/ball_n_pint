...
import { createProduct } from "@/actions/products/products"
...
export function CreateProductForm({ category } : Props) {
        ...
        <DialogFooter>
          <div  className="w-full flex items-center gap-2 mt-2">
            ...
            <Button type="submit" disabled={isLoading} size="sm">
              <LoadingSwap isLoading={isLoading} >Créer le produit</LoadingSwap>
            </Button>
          </div>
        </DialogFooter>
      </form>
