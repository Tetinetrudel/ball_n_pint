...
import { CreateClientForm } from "../forms/add-client-form"
...
export function ClientsDataTable({ data }: ClientsDataTableProps) {
  ...
  const table = useReactTable<ClientWithRelations>({
    data,
    columns,
    ...
    <Card className="shadow-none ring-0 border-none">
      <CardHeader className="flex flex-row items-center justify-between">
        <div>
          ...
          <CardDescription>{data.length} clients trouvés</CardDescription>
        </div>
        <Dialog>
